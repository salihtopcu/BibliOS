...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BibliOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7BibliOS12AKPickerView")
...
SWIFT_PROTOCOL("_TtP7BibliOS22AKPickerViewDataSource_")
...
SWIFT_PROTOCOL("_TtP7BibliOS20AKPickerViewDelegate_")
...
SWIFT_CLASS("_TtC7BibliOS17APJTextPickerView")
@interface APJTextPickerView : UITextField
...
@interface APJTextPickerView (SWIFT_EXTENSION(BibliOS)) <UIPickerViewDelegate>
- (NSString * _Nullable)pickerView:(UIPickerView * _Nonnull)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end


@interface APJTextPickerView (SWIFT_EXTENSION(BibliOS)) <UIPickerViewDataSource>
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC7BibliOS3Dao")
...
SWIFT_CLASS("_TtC7BibliOS12AlamofireDao")
@interface AlamofireDao : Dao
@end
...
SWIFT_CLASS("_TtC7BibliOS14FileDownloader")
@interface FileDownloader : Dao
@end




SWIFT_CLASS("_TtC7BibliOS10SLHTabView")
@interface SLHTabView : UIView
...
SWIFT_CLASS("_TtC7BibliOS12SLHTableView")
@interface SLHTableView : UITableView <UITableViewDataSource, UITableViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC7BibliOS16SLHTableViewCell")
@interface SLHTableViewCell : UITableViewCell
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
